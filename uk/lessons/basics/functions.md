...
Також в Elixir є можливість визначати іменовані функції для подальшого їх виклику за цими іменами. Ці функції оголошуються за допомогою ключового слова `def` в контексті модуля. Про модулі буде докладніше розказано в наступних уроках, в цьому ж ми зосередимося тільки на іменованих функціях.
